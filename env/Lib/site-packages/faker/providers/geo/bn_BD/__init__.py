...
class Provider(GeoProvider):
    ...
    land_coords = (
        ...
        (
            ...
            "তান্ডিল",
            "AR",
            "আমেরিকা/আর্জেন্টিনা/বুয়েনস_আয়ারস",
        ),
        (
            "-34.74785",
            "-58.70072",
        ...
        (
            "41.41204",
            "2.18247",
            "এল ক্যাম্প দে ল আর্পা দেল ক্লট",
            "ES",
            "ইউরোপ/মাদ্রিদ",
        ),
    ...
    def local_latlng(
        self, country_code: str = "BD", coords_only: bool = False
    ) -> Optional[Tuple[str, ...]]:
        """Set Bangladesh BD as country code."""
        return super(self.__class__, self).local_latlng(
            country_code=country_code, coords_only=coords_only
        )
