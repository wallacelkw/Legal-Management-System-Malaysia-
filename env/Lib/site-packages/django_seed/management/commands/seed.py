...
class Command(AppCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            "--number", nargs="?", type=int, default=10, const=10, help=help_text
        )
    ...
    def handle_app_config(self, app_config, **options):
        ...
        for model in self.sorted_models(app_config):
            if model.__name__ in seeders:
                print("Custom seeder {}".format(seeders[model.__name__]))
    ...
    def get_model_dependencies(self, models):
        ...
        for model in models:
            dependencies = set()
            model_replacement = "{}.{}".format(model.__module__, model.__name__)
            ...
            for field in model._meta.get_fields():
                if (
                    (
                        field.many_to_one is True
                        or field.many_to_many is True
                        or field.one_to_one is True
                    )
                    and field.concrete
