...
class Parser(object):
    ...
    def _err_str(self):
        ...
        return "%s:%d Unexpected %s at column %d" % (self.fname, lineno, thing, colno)
    ...
    def _ws__c8__s0_n_n_g__c0_(self):
        self._seq(
            [lambda: self._bind(self._anything_, "x"), self._ws__c8__s0_n_n_g__c0__s1_]
        )
    ...
    def _comment__c0_(self):
        self._seq(
            [lambda: self._str("//"), lambda: self._star(self._comment__c0__s1_p_)]
        )
    ...
    def _comment__c1_(self):
        self._seq(
            [lambda: self._str("/*"), self._comment__c1__s1_, lambda: self._str("*/")]
        )
